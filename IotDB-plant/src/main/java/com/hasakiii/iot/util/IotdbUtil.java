...
public class IotdbUtil {
     ...
     * 使用sql语句之前需要先调用Connection对象的createStatement()创建一个statement方法
     * <p>
     * After creating a Statement object, you can use its execute() method to execute a SQL statement
     * 创建一个statement对象后可以使用execute()方法执行sql语句
     * <p>
     ...
     * 通过statement的getResultSet()方法获取查询结果集
     */
    //  JDBC driver name and database URL
    private static String driver = "org.apache.iotdb.jdbc.IoTDBDriver";
